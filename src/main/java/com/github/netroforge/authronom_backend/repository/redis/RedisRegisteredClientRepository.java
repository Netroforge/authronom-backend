...
public class RedisRegisteredClientRepository implements RegisteredClientRepository {
	...
	public void save(RegisteredClient registeredClient) {
		...
		registeredClientRepository.save(oauth2RegisteredClient);
	}
	...
	public RegisteredClient findById(String id) {
		...
		return registeredClientRepository.findById(id).map(ModelMapper::convertRegisteredClient).orElse(null);
	}
	...
	public RegisteredClient findByClientId(String clientId) {
		...
		OAuth2RegisteredClient oauth2RegisteredClient = registeredClientRepository.findByClientId(clientId);
